...
namespace CustomMultiplayerMaps
{
    ...
    public class main : MelonMod
    {
        ...
        public void LoadCustomMap(string[] recievedText)
        {
            ...
            for (int i = 0; i < childCount; i++)
            {
                ...
                else if (primitiveName.ToLower().Contains("environment"))
                {
                    shape.layer = 10;
        ...
        //By LMSparrow
        public void LoadKingOfTheThrone()
        {
            GameObject mapParent = new GameObject();
            ...
            GameObject shape;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cylinder);
            shape.name = "Cylinder(invisible)(Environment)(Wall)";
            Component.Destroy(shape.GetComponent<CapsuleCollider>());
            shape.AddComponent<BoxCollider>();
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 10;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-10.6125f, -10f, 0f);
            shape.transform.rotation = Quaternion.Euler(-0f, 0f, 0f);
            shape.transform.localScale = new Vector3(100f, 0.1f, 100f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cylinder);
            shape.name = "Cylinder(Wall)";
            Component.Destroy(shape.GetComponent<CapsuleCollider>());
            shape.AddComponent<BoxCollider>();
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.4745f, 0.30979988f, 0.23919985f);
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            shape.name = "Quad(Wall)";
            shape.AddComponent<BoxCollider>();
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.8431f, 0.7373f, 0.55689996f);
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-4f, -4f, 0f);
            shape.transform.rotation = Quaternion.Euler(0f, 270f, 0f);
            shape.transform.localScale = new Vector3(8f, 1f, 1f);
            meshCollider = shape.GetComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(1f, -3.99f, 0f);
            shape.transform.rotation = Quaternion.Euler(0f, 270f, 0f);
            shape.transform.localScale = new Vector3(25.000002f, 0.01f, 13f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Sphere);
            shape.name = "Sphere(Wall)";
            Component.Destroy(shape.GetComponent<SphereCollider>());
            shape.AddComponent<BoxCollider>();
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.4745f, 0.30979988f, 0.23919985f);
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-4f, -3f, -9f);
            shape.transform.rotation = Quaternion.Euler(0f, 270f, 0f);
            shape.transform.localScale = new Vector3(9.999999f, 4.25f, 1f);
            meshCollider = shape.GetComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-5f, -3.5f, 0f);
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-10f, -1f, -4f);
            shape.transform.rotation = Quaternion.Euler(-0f, -0f, 90f);
            shape.transform.localScale = new Vector3(2f, 4.9999995f, 2f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-10f, -3.125f, -3f);
            ...
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-5f, -3f, 4f);
            shape.transform.rotation = Quaternion.Euler(4.768376E-07f, 271.69397f, -2.1425876E-07f);
            shape.transform.localScale = new Vector3(2.0000002f, 2f, 2.0000002f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-10f, -0.01f, 9f);
            shape.transform.rotation = Quaternion.Euler(0f, 270f, 0f);
            shape.transform.localScale = new Vector3(9.999999f, 0.01f, 9.999999f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-22.35f, 3.74f, 0f);
            shape.transform.rotation = Quaternion.Euler(0f, 270f, 0f);
            shape.transform.localScale = new Vector3(37.5f, 0.01f, 12.75f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-16f, 2.75f, 0f);
            shape.transform.rotation = Quaternion.Euler(-0f, 270f, 90f);
            shape.transform.localScale = new Vector3(2f, 18.75f, 2f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-15f, -1.25f, 0f);
            shape.transform.rotation = Quaternion.Euler(0f, 270f, 0f);
            ...
            Component.Destroy(shape.GetComponent<BoxCollider>());
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.39999986f, 0.555f, 1f);
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-12.9024f, -4.5536f, -7.348f);
            shape.transform.rotation = Quaternion.Euler(4.768376E-07f, 271.69397f, -2.1425876E-07f);
            ...
            shape.transform.position = new Vector3(-12.9024f, -4.5536f, 7.348f);
            shape.transform.rotation = Quaternion.Euler(0f, 270f, 0f);
            shape.transform.localScale = new Vector3(0.7500001f, 0.75f, 0.7500001f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-9f, -6.5f, -8.5f);
            shape.transform.rotation = Quaternion.Euler(320f, 1.1145224E-06f, 330f);
            shape.transform.localScale = new Vector3(27.5f, 25f, 0.099999994f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-10f, -2.51f, 0f);
            shape.transform.rotation = Quaternion.Euler(0f, 270f, 0f);
            shape.transform.localScale = new Vector3(6.0000005f, 0.01f, 9.999999f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-22.25f, 4.5f, -15f);
            shape.transform.rotation = Quaternion.Euler(344.99997f, 29.99999f, 0f);
            ...
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-9f, -6.5f, 8.5f);
            shape.transform.rotation = Quaternion.Euler(40.000008f, -4.458089E-06f, 59.999996f);
            shape.transform.localScale = new Vector3(25.000002f, 27.5f, 0.1f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cylinder);
            shape.name = "Cylinder(Wall)(Environment)";
            Component.Destroy(shape.GetComponent<CapsuleCollider>());
            shape.AddComponent<BoxCollider>();
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.7f, 0.23139986f, 0.23139986f);
            shape.layer = 10;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-30.85f, 15f, 0f);
            shape.transform.rotation = Quaternion.Euler(90f, 0f, 0f);
            shape.transform.localScale = new Vector3(1f, 13.500001f, 1f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            ...
            shape.layer = 10;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-24.125f, 15f, -17f);
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-28.5f, 4.5f, 0f);
            shape.transform.rotation = Quaternion.Euler(345f, 90f, 0f);
            shape.transform.localScale = new Vector3(25.500004f, 21.500004f, 0.09999998f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            ...
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(-22.25f, 4.5f, 15f);
            shape.transform.rotation = Quaternion.Euler(15.000006f, 330f, 1.3258372E-06f);
            shape.transform.localScale = new Vector3(15f, 21.500002f, 0.09999999f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube(Wall)(Environment)(Invisble)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            shape.AddComponent<BoxCollider>();
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(1f, 1f, 1f);
            shape.layer = 10;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(1f, -4f, 0f);
            shape.transform.rotation = Quaternion.Euler(0f, 270f, 0f);
            shape.transform.localScale = new Vector3(25.000004f, 0.01f, 13.000001f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            groundCollider.collider = meshCollider;
        ...
        public void LoadSprinkleDonut()
        {
            ...
            Component.Destroy(shape.GetComponent<BoxCollider>());
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.7612699f, 0.12711167f, 0.4813732f);
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 35.999813f, -0f);
            shape.transform.localScale = new Vector3(8.93135f, 0.027901676f, 2.58311f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 23.999802f, -0f);
            shape.transform.localScale = new Vector3(8.93135f, 0.027901676f, 2.58311f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 57.005203f, -0f);
            shape.transform.localScale = new Vector3(0.18377572f, 0.035000004f, 1.48f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 21.651234f, -0f);
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 2.5642977f, -0f);
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 2.1399972f, -0f);
            shape.transform.localScale = new Vector3(0.18377572f, 0.035000004f, 1.48f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 31.223822f, -0f);
            shape.transform.localScale = new Vector3(0.23890838f, 0.035f, 1.4800001f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 12.309904f, -0f);
            ...
            shape.transform.rotation = Quaternion.Euler(0f, 286.02774f, 0f);
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 44.378f, -0f);
            shape.transform.localScale = new Vector3(0.18377572f, 0.035000004f, 1.48f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 29.858227f, -0f);
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 4.811931f, -0f);
            shape.transform.localScale = new Vector3(0.18377572f, 0.035000004f, 1.48f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube sprinkle.047";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.35959402f, 0f, 1f);
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 6.6278963f, -0f);
            shape.transform.localScale = new Vector3(0.18377572f, 0.035000004f, 1.48f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 3.0215294f, -0f);
            shape.transform.localScale = new Vector3(0.18377572f, 0.035000004f, 1.48f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            groundCollider.isMainGroundCollider = true;
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 40.829056f, -0f);
            ...
            shape.transform.rotation = Quaternion.Euler(-0f, 51.66425f, -0f);
            ...
            Component.Destroy(shape.GetComponent<BoxCollider>());
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(1f, 0.42739323f, 0.20694187f);
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).059(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).058(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).057(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).056(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).055(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).054(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).053(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).052(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).051(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).050(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).049(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).048(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).047(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).046(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).045(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).044(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).043(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).042(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).041(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).040(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).039(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).038(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).037(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).036(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).035(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).034(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).033(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).032(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).031(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            ...
            groundCollider.collider = meshCollider;
            shape = GameObject.CreatePrimitive(PrimitiveType.Cube);
            shape.name = "Cube.invisible (I).030(Invisible)";
            Component.Destroy(shape.GetComponent<BoxCollider>());
            Component.Destroy(shape.GetComponent<MeshRenderer>());
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
        ...
        private void LoadEarthRumbleArena()
        {
            ...
            Component.Destroy(shape.GetComponent<BoxCollider>());
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.52f, 0.4699998f, 0.1799998f);
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(0f, -0.29999998f, 0f);
            shape.transform.rotation = Quaternion.Euler(-0f, 90f, -0f);
            ...
            Component.Destroy(shape.GetComponent<BoxCollider>());
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.52f, 0.4699998f, 0.17999965f);
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(0f, -0.061999947f, 0f);
            shape.transform.rotation = Quaternion.Euler(-0f, 0f, 0f);
            ...
            Component.Destroy(shape.GetComponent<SphereCollider>());
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.09999957f, 0.09999957f, 0.07999971f);
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(0f, 35.2f, 0f);
            shape.transform.rotation = Quaternion.Euler(-0f, 0f, 0f);
            ...
            Component.Destroy(shape.GetComponent<BoxCollider>());
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.5399999f, 0.53f, 0.25999963f);
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(7.74f, -0.116f, 0f);
            shape.transform.rotation = Quaternion.Euler(-0f, 0f, 0f);
            ...
            Component.Destroy(shape.GetComponent<BoxCollider>());
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.56f, 0.53f, 0.25999948f);
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(1.62f, -0.116f, 0f);
            shape.transform.rotation = Quaternion.Euler(-0f, 0f, 0f);
            ...
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(0f, -0.266f, 0f);
            shape.transform.rotation = Quaternion.Euler(-0f, 90f, -0f);
            shape.transform.localScale = new Vector3(28f, 0.4f, 18f);
            meshCollider = shape.AddComponent<MeshCollider>();
            groundCollider = shape.AddComponent<GroundCollider>();
            ...
            Component.Destroy(shape.GetComponent<CapsuleCollider>());
            shape.GetComponent<Renderer>().material.shader = urp;
            shape.GetComponent<Renderer>().material.color = new Color(0.5399999f, 0.53f, 0.25999957f);
            shape.layer = 9;
            shape.transform.parent = mapParent.transform;
            shape.transform.position = new Vector3(0f, -0.06999999f, 0f);
            shape.transform.rotation = Quaternion.Euler(-0f, 0f, 0f);
